...
Aur haan... birthday tumhara hai, lekin gift mujhe mila tha jab tum meri life mein aayi thi. 🥹❤️`,
  ...
  moments: [
    ...
    { src: memory2, caption: "Our golden hour", sticker: "" },
    { src: memory3, caption: "That little dinner", sticker: "💖" },
    { src: memory4, caption: "Dreaming together", sticker: "" },
    { src: memory2, caption: "Late night talks", sticker: "✨" },
    { src: memory1, caption: "Somewhere in between", sticker: "" },
  ],
  reasons: [
    ...
    { icon: "🕊️", title: "Your heart", text: "Patient, brave and soft all at once — my favourite place in the world." },
  ],
  stats: [
    { value: 730, suffix: "+", label: "Days together" },
    { value: 1200, suffix: "+", label: "Memories made" },
...
function SectionTitle({ script, sub }: { script: string; sub?: string }) {
  return (
    <div className="mb-12 text-center reveal" data-reveal>
      <h2 className="font-script glow-soft text-gradient-romance text-4xl leading-tight sm:text-6xl">
        {script}
      </h2>
      {sub ? (
  ...
  return (
    <div className="relative overflow-hidden bg-romance py-4">
      <div className="flex w-max animate-marquee gap-10 whitespace-nowrap">
        {phrases.map((p, i) => (
          <span key={i} className="font-script text-2xl text-primary-foreground sm:text-3xl">
...
function Finale() {
  ...
  const launch = () => {
    ...
    heartBurst(window.innerWidth / 2, window.innerHeight / 2, 22);
  };
    ...
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <main className="relative z-10">
        ...
        >
          ...
          <h1 className="font-serif-display text-4xl uppercase tracking-[0.2em] text-primary sm:text-6xl">
            Happy Birthday
          </h1>
          ...
          <div className="glass-card relative rounded-[2rem] p-2" data-reveal>
            ...
            <div className="rounded-[1.6rem] border border-dashed border-primary/40 bg-cream/90 px-6 py-10 sm:px-12 sm:py-14 shadow-inner">
              {paragraphs.map((p, i) => (
                <p
                  key={i}
                  className="font-serif-display mb-6 whitespace-pre-line text-lg leading-[2.1] text-foreground/95 font-medium last:mb-0 sm:text-xl"
                >
                  {p}
                </p>
              ))}
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {CONFIG.moments.map((m, i) => (
              ...
              >
                ...
                <figcaption className="mt-4 font-script text-2xl text-primary">{m.caption}</figcaption>
              </figure>
            ))}
          </div>
        </section>
        ...
        <section id="why" className="mx-auto max-w-6xl px-6 py-24">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {CONFIG.reasons.map((r, i) => (
              ...
              >
                ...
                <h3 className="mt-4 font-script text-3xl text-primary">{r.title}</h3>
          ...
          <div className="mt-20" data-reveal>
            <h3 className="reveal text-center font-script text-4xl text-primary">Love, Measured</h3>
            <div className="mt-10 grid gap-6 sm:grid-cols-3">
              {CONFIG.stats.map((s, i) => (
                ...
                >
                  <p className="font-serif-display text-5xl text-primary">
        ...
        <footer className="relative z-10 px-6 pb-16 text-center text-sm text-muted-foreground">
          <p className="font-script text-2xl text-primary">Made with infinite love ❤️</p>
          <p className="mt-2">This moment was crafted entirely for you • {CONFIG.year}</p>
        </footer>
      </main>
    </div>
  );
